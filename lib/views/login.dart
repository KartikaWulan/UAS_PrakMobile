import 'package:griya_gorden/myhomepage.dart';
import 'package:griya_gorden/views/register.dart';
import 'package:griya_gorden/views/bebas.dart';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final snackBar = SnackBar(
          backgroundColor: Color.fromARGB(255, 250, 209, 59),
          content: Text(
            'Login failed',
            style: TextStyle(
          ...
          children: <Widget>[
            ...
            Align(
              ...
              child: Column(
                children: <Widget>[
                  Text(
                    "Selamat datang di Griya Gorden",
                    style: TextStyle(
                      color: Colors.black,
                  ...
                  Text("Login to your account",
                      style: TextStyle(
                        color: Color.fromARGB(255, 0, 129, 13),
                        fontSize: 17,
                      )),
                ],
              ),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                  primary: Color.fromARGB(255, 0, 251, 151),
                ...
                GestureDetector(
                  ...
                  child: Text("Sign up",
                      style: TextStyle(
                        fontFamily: 'Poppins Light',
                        fontSize: 16,
                        color: Color.fromARGB(255, 0, 251, 151),
                      )),
                ),
              ],
            ),
